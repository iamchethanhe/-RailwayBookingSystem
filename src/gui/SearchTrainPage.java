...
public class SearchTrainPage extends JFrame {
    ...
    public SearchTrainPage() {
        ...
        txtFrom.setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10));
        ...
        txtTo.setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10));
        ...
        btnSearch.addActionListener(e -> {
            ...
            if (from.isEmpty() || to.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Enter From & To");
            } else {
                new ViewTrainPage(from, to, "Today").setVisible(true);
                dispose();
            }
        });
