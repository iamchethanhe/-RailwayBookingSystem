...
public class PaymentPage extends JFrame {
    ...
    public PaymentPage(String train, String from, String to, int basePrice, String date, String category, String time, int tickets, int total, String seatNumbers) {
        ...
        JLabel lblTickets = new JLabel("Tickets: " + tickets);

        gbc.gridy = 3;
        card.add(lblTickets, gbc);

        JLabel lblSeats = new JLabel("Seats: " + seatNumbers);

        gbc.gridy = 4;
        card.add(lblSeats, gbc);

        JLabel lblTotal = new JLabel("Total Amount: ₹" + total);
        ...
        JLabel lblDetails = new JLabel("Payment Details");
        ...
        btnPay.setBackground(new Color(37, 99, 235));
        ...
        btnPay.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String pnr = "PNR" + (int)(Math.random() * 1000000000);

                    java.sql.Connection con = DBConnection.getConnection();

                    java.sql.PreparedStatement seatPs = con.prepareStatement(
                            "SELECT available_seats FROM trains WHERE train_name=?"
                    );

                    seatPs.setString(1, train);

                    java.sql.ResultSet seatRs = seatPs.executeQuery();
                    ...
                    java.sql.PreparedStatement updateSeatPs = con.prepareStatement(
                            "UPDATE trains SET available_seats = available_seats - ? WHERE train_name=?"
                    );

                    updateSeatPs.setInt(1, tickets);
                    updateSeatPs.setString(2, train);
        ...
        btnBack.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                new BookingPage(train, from, to, basePrice, date).setVisible(true);
