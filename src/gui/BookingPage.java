...
public class BookingPage extends JFrame {
    ...
    JCheckBox seat1, seat2, seat3, seat4, seat5, seat6, seat7, seat8;
    ...
    public BookingPage(String train, String from, String to, int basePrice, String date) {
        ...
        card.setPreferredSize(new Dimension(450, 540));
        ...
        JLabel lblSeats = new JLabel("Available Seats: Loading...");
        ...
        JPanel seatPanel = new JPanel(new GridLayout(2, 4, 10, 10));
        ...
        JButton btnBook = new JButton("Proceed To Payment");
        ...
        try {
            ...
            java.sql.PreparedStatement ps =
                    con.prepareStatement("SELECT available_seats FROM trains WHERE train_name=?");
            ...
            if (rs.next()) {
                ...
                lblSeats.setText("Available Seats: " + rs.getInt("available_seats"));
            }
                ...
                try {
                    ...
                    for (int i = 0; i < seats.length; i++) {
                        ...
                        if (seats[i].isSelected()) {
                            ...
                            seatNumbers += seats[i].getText() + ",";
                        }
                    }

                    if (selectedSeats != tickets) {

                        JOptionPane.showMessageDialog(null, "Select exactly " + tickets + " seats");
                    ...
                    new PaymentPage(
                            train, from, to, basePrice,
                            date, category, time,
                            tickets, total, seatNumbers
                    ).setVisible(true);
